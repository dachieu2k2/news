...
export const SimpleVideoCard = () => (
  <div
    className={`relative max-w-full max-h-[400px] transition-all duration-300 cursor-pointer filter grayscale-[40%] hover:grayscale-0 overflow-hidden`}
  >
    <Link href="/">
      <img
    ...
    <div className="flex flex-col justify-between leading-3">
      <p className="lg:mt-6 my-2 font-normal font-roboto text-xs  text-text-color-39">
        Craig Bator - <span className="text-text-color-39/60">27 Dec 2020</span>
      </p>
